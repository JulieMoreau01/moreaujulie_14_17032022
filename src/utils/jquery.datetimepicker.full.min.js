          ...
          function f() {
            ...
            return (
              N.startDate
                ...
                ? ((t = W.strToDateTime(t)),
                  N.yearOffset && (t = new Date(t.getFullYear() - N.yearOffset, t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds())))
            ...
            (W = new (function () {
              ...
              ;(r.now = function (e) {
                ...
                return (
                  ...
                  !e &&
                    N.defaultTime &&
                    ((a = r.strtotime(N.defaultTime)), n.setHours(a.getHours()), n.setMinutes(a.getMinutes()), n.setSeconds(a.getSeconds()), n.setMilliseconds(a.getMilliseconds())),
                  n
                )
              }),
                ...
                (r.str = function () {
                  var e = N.format
                  return (
                    N.yearOffset && (e = (e = e.replace('Y', r.currentTime.getFullYear() + N.yearOffset)).replace('y', String(r.currentTime.getFullYear() + N.yearOffset).substring(2, 4))),
